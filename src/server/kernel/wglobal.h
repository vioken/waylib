...
public:
    // Specially for connecting QObject::objectNameChanged
    template<typename Func1, typename Func2>
    requires std::is_same_v<QObject, typename QtPrivate::FunctionPointer<Func1>::Object>
        && (QtPrivate::FunctionPointer<Func1>::ArgumentCount == 2)
    QMetaObject::Connection safeConnect(Func1 signal, const QObject *receiver, Func2 slot, Qt::ConnectionType type = Qt::AutoConnection) {
        beginSafeConnect();
        auto connection = QObject::connect(qobject_cast<typename QtPrivate::FunctionPointer<Func1>::Object*>(this), signal, receiver, slot, type);
